            ...
            box = $("#chat_div").chatbox(
                    {
                         ...
                         */
                      title: '<div style="display:block" onclick="audioStart();" id="play"><span class="glyphicon glyphicon-headphones"></span> <button  style="width: 24%; height: 30px;">Play</button></div>   <div style="display:none" onclick="audioStop();" id="stop"><span class="glyphicon glyphicon-headphones"></span> <button  style="width: 24%; height: 30px;">Stop</button></div>',
                         // title: '<span style="display:block" onclick="audioStart();" id="play"><span class="glyphicon glyphicon-headphones "></span> <span class="glyphicon glyphicon-play"></span></span>    <span style="display:none" onclick="audioStop();" id="stop"><span class="glyphicon glyphicon-headphones"></span> <span class="glyphicon glyphicon-stop" ></span></span>',
                          // title: 'Runnable User ',
                        /*
...
//                            var resApiResponse=["How are you?","Fine"];
                            if (msg != null) {
                                ...
                                $.post("/api-ai-service/query-agent",
                                        {
                                            name: msg
                                        },
