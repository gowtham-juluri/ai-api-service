...
(function (window) {
  ...
  $('#multi-button').click(function(event) {
     ...
     var isReqId=1;
     var isListId=1;
    $('#intent-parameters-table tbody tr td').each( function(){
    ...
    jsonObj.push(jsonData);
        //different action for file brwsing
      
      //tranningContentSave
      var formdata=new FormData($('form')[0]);
            $.ajax({
                url: "/api-ai-service/store-train-data",
                type: "POST",
                data: formdata,
    ...
    $("#intent-add-param").click(function(){
     dynamicId=dynamicId+1;
            $("#intent-parameters-table").append('<tr class="row" > <td class="col-sm-1"  ></td><td class="col-sm-1" ><input id="isRequired'+dynamicId+'" type="checkbox" name="is-required"> </td>  <td class="col-sm-3" ><input placeholder="Enter name" type="text" name="actionParameter" ></td>  <td class="col-sm-3" ><input placeholder="Enter entity" type="text" name="actionName" ></td>  <td class="col-sm-3" ><input placeholder="Enter value" type="text" name="actionValue"></td>  <td  class="col-sm-1"><input placeholder="Enter entity" type="checkbox" name="is-list" id="isList'+dynamicId+'"></td></tr>');
        });
      });
})(window);